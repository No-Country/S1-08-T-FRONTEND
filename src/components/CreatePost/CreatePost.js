...
import { uploadVideo } from '../../app/services/images';
...
export default function CreatePost() {
  ...
  const [createImage] = useUploadPostsImageMutation();
  const [createVideo] = useUploadPostsVideoMutation();
      ...
      <form className='formPost' onSubmit={handleSubmit}>   
        <div className='creatPostContainer'>
            ...
            <div className='uploadMedia'>
              ...
              <label htmlFor='fileidVideo'>Elegí tu video</label>
                <input 
