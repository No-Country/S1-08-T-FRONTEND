...
export default function FeedCard() {
  ...
  return (
    <div className="feedCard">
      <Card sx={{ marginTop: 12, marginLeft: 2, marginRight: 2, maxWidth: 765,  maxHeight: 800, backgroundColor: "#fbf9f7" }}>
      ...
      <Footer className="footer" /> {/*es para ver como se ve, cdo use Feed, tengo que sacar esto.*/}
    </div>
  );
}
